...
% $Log: jmatopoplot.m,v $
% Revision 1.1  2009/05/18 21:18:25  ales
% silly change to EEGLAB function for different interp type
%
...
%  [Xi,Yi,Zi] = griddata(inty,intx,intValues,yi',xi,'invdist'); % interpolate data
  [Xi,Yi,Zi] = griddata(inty,intx,intValues,yi',xi,'linear'); % interpolate data
