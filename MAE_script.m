...
%% Load data
adaptData = load('/Users/ales/data/MAE/Ales/Exp_MATL_HCN_128_Avg/Axx_c003.mat');
jitterData = load('/Users/ales/data/MAE/Ales/Exp_MATL_HCN_128_Avg/Axx_c004.mat');
otherAdaptData = load('/Users/ales/data/MAE/Ales/Exp_MATL_HCN_128_Avg_adapt2/Axx_c003.mat');
...
figure(40)
clf
bar(flist,jitterData.Amp(:,75),.5,'w');
axis([-.50 53.5 0 1.5]);
hold on;
sigList = [ 37 18*4+1];
bar(flist(sigList),jitterData.Amp(sigList,75),.01,'k');
axis([-.50 53.5 0 1.5]);

figure(41)
clf
bar(flist,adaptData.Amp(:,75),.5,'w');
axis([-.50 53.5 0 1.5]);
hold on;
sigList = [19 37 18*3+1 18*4+1];
bar(flist(sigList),adaptData.Amp(sigList,75),.02,'k');
axis([-.50 53.5 0 1.5]);
