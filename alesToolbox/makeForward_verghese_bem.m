...
fwOPTIONS.ChannelFile = '/Users/ales/data/verghese/preeti_emseScalp_Channel.mat';
...
fwOPTIONS.Cortex.FileName = '/Users/ales/data/verghese/preeti_subjecttess';
...
fwOPTIONS.BEM.EnvelopeNames{1}.TessFile = '/Users/ales/data/verghese/preeti_subjecttess';
fwOPTIONS.BEM.EnvelopeNames{1}.TessFile = '/Users/ales/data/verghese/preeti_subjecttess';
fwOPTIONS.BEM.EnvelopeNames{1}.TessName = 'inner_skull';



fwOPTIONS.BEM.EnvelopeNames{2}.TessFile = '/Users/ales/data/verghese/preeti_subjecttess';
fwOPTIONS.BEM.EnvelopeNames{2}.TessName = 'outer_skull';


fwOPTIONS.BEM.EnvelopeNames{3}.TessFile = '/Users/ales/data/verghese/preeti_subjecttess';
...
% Store arguments to be passed to main script in fwOPTIONS structure
%StudyFile = '/home/ales/data/new_ucb/study/Testing/Testing_brainstormstudy.mat'; % path to BrainStorm studyfile (i.e. database entry) % EDIT
fwOPTIONS.Method = {'eeg_3sphereberg'}; 
fwOPTIONS.ChannelFile = '/Users/ales/data/verghese/preeti_emseScalp_Channel.mat';
fwOPTIONS.rooot = '/Users/ales/data/verghese';
fwOPTIONS.ChannelType = 'EEG';
...
% Type HELP BST_HEADMODELER.M for further info on the following arguments 
%fwOPTIONS.HeadModelFile = 'tcBEM';
fwOPTIONS.ImageGridFile = 'pvSphere';
fwOPTIONS.FileNamePrefix = 'pvSphere';
fwOPTIONS.Verbose = 1;
