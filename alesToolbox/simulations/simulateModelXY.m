...
figure(20)
subplot(1,4,1)
plot(iI,powSpec(5),mkCol,'linewidth',3)
hold on;
title('3 Hz')
subplot(1,4,2)
plot(iI,powSpec(9),mkCol,'linewidth',3)
hold on;
title('6 Hz')
subplot(1,4,3)
...
title('9 Hz')
subplot(1,4,4)
plot(iI,powSpec(17),mkCol,'linewidth',3)
hold on;
title('12 Hz')

figure(21)
plot(iI,sqrt(sum(powSpec(5:4:150).^2)),mkCol,'linewidth',3)
hold on;
